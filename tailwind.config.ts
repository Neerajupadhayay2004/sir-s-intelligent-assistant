...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        jarvis: ["Orbitron", "system-ui", "sans-serif"],
      },
      colors: {
        ...
        jarvis: {
          ...
          "cyan-glow": "hsl(var(--jarvis-cyan-glow))",
          "cyan-dim": "hsl(var(--jarvis-cyan-dim))",
          orange: "hsl(var(--jarvis-orange))",
          "orange-glow": "hsl(var(--jarvis-orange-glow))",
          dark: "hsl(var(--jarvis-dark))",
          surface: "hsl(var(--jarvis-surface))",
          line: "hsl(var(--jarvis-line))",
        },
        sidebar: {
